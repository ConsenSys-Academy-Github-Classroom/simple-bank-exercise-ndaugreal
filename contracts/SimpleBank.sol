...
contract SimpleBank {
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      // Do not use this: (bool success,) = msg.sender.call{value: withdrawAmount}("");
      // Reference: https://docs.soliditylang.org/en/v0.8.7/security-considerations.html?highlight=msg.sender.call#re-entrancy
